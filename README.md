...
| `OPENCODE_BASE_URL`                                  | No       | `https://opencode.ai/zen/go/v1`                | Base URL of the OpenAI-compatible endpoint used by both the conversation agent and image analysis chat models. Unprefixed for the same reason as `OPENCODE_API_KEY`.                                                                                                                                      |
