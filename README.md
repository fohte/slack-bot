...
`pnpm print-slash-commands` builds this JSON from `PluginRegistry.buildAppManifestCommands()`, so it always reflects the currently registered plugins.
